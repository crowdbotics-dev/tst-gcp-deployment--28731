...
## Project Structure
    ...
    ├── tst_gcp_deployment__28731  # Django project configurations
...
1. Clone this repo and `cd tst_gcp_deployment__28731`
...
2. Clone this repo and `cd tst_gcp_deployment__28731`
